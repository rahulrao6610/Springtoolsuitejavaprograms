...
public class PolyDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println("WELLCOME....TO____CANARABANK!");
	    bank.checkBalance();
		bank.withDraw(2300);
		bank.deposit(35700);
		bank.checkBalance();
		System.out.println("Canarabank ends here----->Thankyou for Using Canara Bank");
		bank =  new KotakBank(75000);
		System.out.println("WELLCOME.....TO____kOTAKBANK!");
		bank.checkBalance();
		bank.withDraw(2300);
		bank.deposit(35700);
		bank.checkBalance();
		System.out.println("Kotakbank ends here----->Thankyou for Using Kotak Bank");
		bank = new YesBank(85000);
		System.out.println("WELLCOME....TO___YESBANK!");
		bank.checkBalance();
		bank.withDraw(2300);
		bank.deposit(35700);
		bank.checkBalance();
		System.out.println("YesBank ends here----->Thankyou for Using Yes Bank");
	}
